<script>
    ...
    async function fetchData() {
        ...
        const response5 = await fetch('http://10.0.4.204:8080/tempf');
        const newData5 = await response5.json();
        tempfHome = newData5;

        const response6 = await fetch('http://10.0.4.204:8080/tempc');
        const newData6 = await response6.json();
        tempcHome = newData6;

        const response7 = await fetch('http://10.0.4.204:8080/humi');
        const newData7 = await response7.json();
        humiHome = newData7;

        const response8 = await fetch('http://10.0.4.204:8080/timestamp');
